...
require '../../PHPMailer_5.2.4/test/PHPUnit/Autoload.php';
...
class phpmailerTest extends PHPUnit_Framework_TestCase
{
    ...
    function setUp()
    {
        ...
        if (file_exists('../../PHPMailer_5.2.4/test/testbootstrap.php')) {
            include '../../PHPMailer_5.2.4/test/testbootstrap.php'; //Overrides go in here
        }
