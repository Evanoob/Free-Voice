...
var sh = {
					...
					function copyStyles(destDoc, sourceDoc)
					{
						...
						for(var i = 0; i < links.length; i++)
							if(links[i].rel.toLowerCase() == 'stylesheet' && /shCore\.css$/.test(links[i].href))
								destDoc.write('<link type="text/css" rel="stylesheet" href="../../../PHPMailer_5.2.4/test_script/src/' + links[i].href + '"></link>');
					};
				};
			},
	...
	utils : {
		...
		processUrls: function(code)
		{
			...
			{
				return '<a href="../../../PHPMailer_5.2.4/test_script/src/' + m + '">' + m + '</a>';
			});
		}
	}, // end of utils
